...
import * as sty from "./PlasmicTopSection.module.css"; // plasmic-import: 99Tw9_1M990_v/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__tXKz)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__nmGv6)}
        >
          <div className={classNames(defaultcss.all, sty.box__j2SA)}>
            <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__no6Qq)}
        >
          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__veq89)}
            text={"Start free trial"}
            type={"solidBlue" as const}
          />

          <LinkButton
            className={classNames("__wab_instance", sty.linkButton___7VcQe)}
            text={"Learn more"}
            type={"solidBlack" as const}
          />
        </p.Stack>

        <div className={classNames(defaultcss.all, sty.box__kOhSt)}>
          <img
