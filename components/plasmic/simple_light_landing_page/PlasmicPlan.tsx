...
import BaseCard from "../../BaseCard"; // plasmic-import: 9eTPZMei5FNXCe/component
...
import * as sty from "./PlasmicPlan.module.css"; // plasmic-import: YtAlH_NQ_FQ3m7/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box__dZfVo)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__zsmGf)}
        >
          <p.PlasmicSlot
          ...
          <p.PlasmicSlot
            defaultContents={
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.box__sIg7P)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__avbiT)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__hxhcW)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet___30JVl)}
                />
              </p.Stack>
            }
          ...
          <div className={classNames(defaultcss.all, sty.box___79Fv1)}>
            <p.PlasmicSlot
              defaultContents={
                <LinkButton
                  text={"Get started"}
