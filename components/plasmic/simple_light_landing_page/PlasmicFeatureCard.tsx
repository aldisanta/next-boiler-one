...
import * as sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: CosNx7E37499C/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.box__dt59, {
            [sty.box__long__dt59HYmg8]: hasVariant(variants, "long", "long")
          })}
        >
          <div
            className={classNames(defaultcss.all, sty.box__oZtA, {
              [sty.box__long__oZtAhYmg8]: hasVariant(variants, "long", "long")
            })}
          >
            <p.PlasmicSlot
              defaultContents={
                <svg
                  className={classNames(defaultcss.all, sty.svg__mlMow)}
                  role={"img"}
                />
              }
      ...
      <div
        className={classNames(defaultcss.all, sty.box___7RZNl, {
          [sty.box__long___7RZNlHYmg8]: hasVariant(variants, "long", "long")
        })}
      >
        <p.PlasmicSlot
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__f2FOi, {
            [sty.box__long__f2FOiHYmg8]: hasVariant(variants, "long", "long")
          })}
        >
          <p.PlasmicSlot
            defaultContents={
              <svg
                className={classNames(defaultcss.all, sty.svg__cng8D)}
                role={"img"}
              />
            }
            value={args.iconBack}
