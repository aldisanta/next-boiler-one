...
import * as sty from "./PlasmicHomeCta.module.css"; // plasmic-import: uHgAdlhFQ8iXe/css

import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: 6BSOEN7CVN3jkS/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__gi4F8)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__ig5Ty)}
        >
          <input
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? false : true) ? (
        <div className={classNames(defaultcss.all, sty.box__v4Iwf)}>
          <SphereIcon
