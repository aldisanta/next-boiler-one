...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: JG8onQoTOJDIZe/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__ciHaH)}
      >
        <div className={classNames(defaultcss.all, sty.box___7LGNi)}>
          <div className={classNames(defaultcss.all, sty.box__nJmeN)}>
            <p.PlasmicSlot
