...
import * as sty from "./PlasmicAvatar.module.css"; // plasmic-import: 0GqAoJN5u3Tl_e/css
    ...
    >
      <p.PlasmicSlot
        defaultContents={
          <img
            alt={""}
            className={classNames(defaultcss.img, sty.img__c5Q5S)}
            role={"img"}
