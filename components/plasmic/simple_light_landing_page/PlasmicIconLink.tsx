...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: uQmNxq2VQM9Ec/css
    ...
    >
      ...
      >
        <p.PlasmicSlot
          defaultContents={
            <svg
              className={classNames(defaultcss.all, sty.svg___87Wp0)}
              role={"img"}
            />
          }
          value={args.icon}
