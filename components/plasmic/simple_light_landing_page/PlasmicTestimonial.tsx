...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: 9s2bO_mmPJm4t_/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: iobzMLC2U825wc/icon
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__thaX3)}
      >
        <div
