...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: 9eTPZMei5FNXCe/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.box__wLis, {
          [sty.box__long__wLis0XmVv]: hasVariant(variants, "long", "long")
        })}
      >
        <p.PlasmicSlot
          defaultContents={
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box___8GqM, {
            [sty.box__long___8GqM0XmVv]: hasVariant(variants, "long", "long")
          })}
        >
          <p.PlasmicSlot
            defaultContents={
              <svg
                className={classNames(defaultcss.all, sty.svg__snp9M)}
                role={"img"}
              />
            }
            value={args.iconBack}
